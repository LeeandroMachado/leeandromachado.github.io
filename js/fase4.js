...
fase4.prototype = {
	init: function(){
  	...
  	create: function(){
		...
		game.add.sprite(0, 0, 'back4');
					
		//Criando porta
		door = game.add.sprite(1200, game.world.height-200, 'door4');
					
		//Criando botão de pause
		botao_pausar = game.add.button(15,15, 'button', pause);
		...
		if(localStorage.getItem('4-hscore') != null){
			hscoreText = game.add.text(this.game.width - 290, 35, 'HIGHSCORE: ' + localStorage.getItem('4-hscore'), {font: "30px cartwheelregular", fill: "#fff"});
		}else{
		...
		background_sound = game.add.audio('background_4');
		background_sound.addMarker('background_4', 1, 3, 1, true);
		...
		areias.enableBody = true;
				
		//Criando areia
		var areia = areias.create(500, game.world.height -40, 'areia');
		areia.body.immovable = true;
		areia = areias.create(850, game.world.height -40, 'areia');
		areia.body.immovable = true;
		var areia = areias.create(1520, game.world.height -40, 'areia');
		areia.scale.setTo(1.8,1);
		areia.body.immovable = true;
		
		
		//Criando o chão
		var ground = platforms.create(0, game.world.height -80, 'ground4_1');
		ground.body.immovable = true;
		ground = platforms.create(1750, game.world.height -80, 'ground4');
		ground.body.immovable = true;
		ground = platforms.create(1020, game.world.height -80, 'ground4_1');
		ground.body.immovable = true;
		ground = platforms.create(650, game.world.height -80, 'ground4');
		ground.body.immovable = true;
		
				
		//Criando Plataformas
		var ledge = platforms.create(400, 650, 'ledge4');
		ledge.body.immovable = true;
		ledge = platforms.create(750, 850, 'ledge4');
		ledge.body.immovable = true;
		ledge = platforms.create(850, 450, 'ledge4');
		ledge.body.immovable = true;
		
		ledge = platforms.create(1100, 650, 'ledge4');
		ledge.body.immovable = true;
		ledge = platforms.create(1600, 850, 'ledge4');
		ledge.body.immovable = true;
		ledge = platforms.create(1450, 450, 'ledge4');
		ledge.body.immovable = true;
		...
		background_sound.play('background_4');
